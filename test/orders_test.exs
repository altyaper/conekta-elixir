  ...
  describe "Orders" do
    test "should get orders" do
      ...
      with_mock Conekta.Client, get_request: fn _ -> expected_mock end do
        ...
        expected_orders =
          {:ok, Poison.decode!(content.body, as: %Conekta.OrdersResponse{})}
    ...
    test "should create an order" do
      ...
      with_mock Conekta.Client,
        post_request: fn _url, _params -> expected_mock end do
        {:ok, content} = expected_mock

        assert Poison.decode(content.body, as: %Conekta.OrdersCreateResponse{}) ==
    ...
    test "should find an order" do
      ...
      with_mock Conekta.Client, get_request: fn _url -> expected_mock end do
        ...
        assert Poison.decode(content.body, as: %Conekta.OrdersFindResponse{}) ==
                 Conekta.Orders.find("ord_2gZKFPPYzE7d7Qeu9")
      end
    end
  end
  ...
  describe "Charges" do
    test "should get charges of an order" do
      ...
      with_mock Conekta.Client, get_request: fn _url -> expected_mock end do
        ...
        assert Poison.decode(content.body, as: %Conekta.OrderChargesResponse{}) ==
                 Conekta.Orders.charges("ord_2gZSnR1CU4zy3PGVz")
      end
    end
  end
end
