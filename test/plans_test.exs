  ...
  describe "Plans" do
    test "should get all plans" do
      ...
      with_mock Client, get_request: fn _ -> expected_mock end do
        ...
        assert Poison.decode(content.body, as: %Conekta.PlansResponse{}) ==
                 Conekta.Plans.plans()
      end
    end
    ...
    test "should get a plan" do
      ...
      with_mock Client, get_request: fn _ -> expected_mock end do
        ...
        assert Poison.decode(content.body, as: %Conekta.PlanFindResponse{}) ==
                 Conekta.Plans.find("plan_2")
      end
    end
    ...
    test "should update a plan" do
      ...
      with_mock Client, put_request: fn _, _ -> expected_mock end do
        ...
        assert Poison.decode(content.body, as: %Conekta.PlanUpdateResponse{}) ==
                 Conekta.Plans.update("plan_2", plan)
      end
    end
    ...
    test "should delete a plan" do
      ...
      with_mock Client, delete_request: fn _ -> expected_mock end do
        ...
        assert Poison.decode(content.body, as: %Conekta.PlanDeleteResponse{}) ==
                 Conekta.Plans.delete("plan_1")
      end
    end
  end
end
