...
defmodule Conekta.ShippingContact do
  ...
  defstruct phone: nil,
            receiver: nil,
            between_streets: nil,
            address: %{street1: nil, postal_code: nil, country: nil}
end
